...
#Reading the image from console
try:
...
#Colors: (255,0,0): RED ; (0,255,0): LIME ; (0, 0, 255): BLUE ; (0, 255, 255): YELLOW
...
#In opencv kernel is used to sharpen or blur the images.
...
def apply_threshold():
	for y in range(height):
		for x in range(width):
			...
			if r + g + b < IMPORTANT_COLOR_LOW_THRESHOLD * 3 or r + g + b > IMPORTANT_COLOR_HIGH_THRESHOLD * 3:
...
#Getting Regions and borders(Dimensions)
...
#_____________________________________________________________________________________________________________________________________#
#Checking whether dimension is inside the image or not
def is_inside(x, y):
	if x < 0 or x >= width or y < 0 or y >= height:
		return False
	return True

#To check whether coordinates are on border
...
#To mark as same region if neighbouring coordinate pixel is same 
...
#To check whether nodes are adjacent
...
#For given nodes calculate edges
def add_graph_edges():
